	...
	<div class="nicdark_section nicdark_bg_greydark_alpha_gradient_2">
		...
		<div class="nicdark_container nicdark_clearfix">
			...
			<div class="grid grid_12">
				<strong class="nicdark_color_white nicdark_font_size_60 nicdark_first_font">CHERCHEUR</strong>
			</div>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="nicdark_width_100_percentage">
            ...
            <div class="grid grid_3">
                <div class="nicdark_section nicdark_position_relative">
                    ...
                    @if($item->img!=null)
                                ...
                                @elseif($item->sexe=="M")
                                <img alt=""  class="nicdark_section  " width="100" height="100" src="{{asset('assets/img/avatarM.jpg')}}">
                                @else
                                <img alt=""  class="nicdark_section  " width="100" height="100" src="{{asset('assets/img/avatarF.jpg')}}">
                                @endif
            ...
            @endforeach
                ...
                <!-- {{ $chercheurs->links() }} -->
                {{ $chercheurs->links('users.layouts.paginate') }}
